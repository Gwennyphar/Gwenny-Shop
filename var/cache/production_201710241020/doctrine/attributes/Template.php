...
/**
 * @ORM\Entity
 * @ORM\Table(name="s_article_configurator_templates_attributes")
 */
class Template extends ModelEntity
{
     ...
     * @var string $attr1
     *
     * @ORM\Column(name="attr1", type="text", nullable=true)
     */
     protected $attr1;
     ...
     * @var string $attr2
     *
     * @ORM\Column(name="attr2", type="text", nullable=true)
     */
     protected $attr2;
     ...
     * @var string $attr3
     *
     * @ORM\Column(name="attr3", type="text", nullable=true)
     */
     protected $attr3;
     ...
     * @var string $attr4
     *
     * @ORM\Column(name="attr4", type="text", nullable=true)
     */
     protected $attr4;
     ...
     * @var string $attr5
     *
     * @ORM\Column(name="attr5", type="text", nullable=true)
     */
     protected $attr5;
     ...
     * @var string $attr6
     *
     * @ORM\Column(name="attr6", type="text", nullable=true)
     */
     protected $attr6;
     ...
     * @var string $attr7
     *
     * @ORM\Column(name="attr7", type="text", nullable=true)
     */
     protected $attr7;
     ...
     * @var string $attr8
     *
     * @ORM\Column(name="attr8", type="text", nullable=true)
     */
     protected $attr8;
     ...
     * @var string $attr11
     *
     * @ORM\Column(name="attr11", type="text", nullable=true)
     */
     protected $attr11;
     ...
     * @var string $attr12
     *
     * @ORM\Column(name="attr12", type="text", nullable=true)
     */
     protected $attr12;
     ...
     * @var string $attr13
     *
     * @ORM\Column(name="attr13", type="text", nullable=true)
     */
     protected $attr13;
     ...
     * @var string $attr14
     *
     * @ORM\Column(name="attr14", type="text", nullable=true)
     */
     protected $attr14;
     ...
     * @var string $attr15
     *
     * @ORM\Column(name="attr15", type="text", nullable=true)
     */
     protected $attr15;
     ...
     * @var string $attr16
     *
     * @ORM\Column(name="attr16", type="text", nullable=true)
     */
     protected $attr16;
     ...
     * @var string $attr17
     *
     * @ORM\Column(name="attr17", type="text", nullable=true)
     */
     protected $attr17;
     ...
     * @var string $attr19
     *
     * @ORM\Column(name="attr19", type="text", nullable=true)
     */
     protected $attr19;
     ...
     * @var string $attr20
     *
     * @ORM\Column(name="attr20", type="text", nullable=true)
     */
     protected $attr20;
