...
class Order extends ModelEntity
{
     ...
     *
     * @ORM\Column(name="swag_payal_billing_agreement_id", type="text", nullable=true)
     */
     protected $swagPayalBillingAgreementId;


    /**
     * @var integer $swagPayalExpress
     *
     * @ORM\Column(name="swag_payal_express", type="integer", nullable=true)
     */
     protected $swagPayalExpress;
    ...
    public function getSwagPayalExpress()
    {
        return $this->swagPayalExpress;
    }

    public function setSwagPayalExpress($swagPayalExpress)
    {
        $this->swagPayalExpress = $swagPayalExpress;
        return $this;
    }
