...
class ShopwareProductionf043d3313d3fe9a3b4816321de40251dead18d95ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'gwen_slogan_of_the_day.slogan_printer' => 'getGwenSloganOfTheDay_SloganPrinterService',
            'gwen_slogan_of_the_day.subscriber.route' => 'getGwenSloganOfTheDay_Subscriber_RouteService',
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '6b31f590524ca83fc1748cc71858c417'), array('hashed_directory_perm' => 493, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'bn_shopware', 'password' => '3586f81c65', 'dbname' => 'bitnami_shopware', 'host' => 'localhost', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3307'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'bn_shopware', 'password' => '3586f81c65', 'dbname' => 'bitnami_shopware', 'host' => 'localhost', 'charset' => 'utf8mb4', 'adapter' => 'pdo_mysql', 'port' => '3307'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    protected function getEventsService()
    {
        ...
        $instance->addSubscriberService('gwen_slogan_of_the_day.subscriber.route', 'GwenSloganOfTheDay\\Subscriber\\RouteSubscriber');
        return $instance;
    }
    ...
    protected function getGwenSloganOfTheDay_SloganPrinterService()
    {
        return $this->services['gwen_slogan_of_the_day.slogan_printer'] = new \GwenSloganOfTheDay\Components\SloganPrinter();
    }
    protected function getGwenSloganOfTheDay_Subscriber_RouteService()
    {
        return $this->services['gwen_slogan_of_the_day.subscriber.route'] = new \GwenSloganOfTheDay\Subscriber\RouteSubscriber('GwenSloganOfTheDay', '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/GwenSloganOfTheDay', $this->get('gwen_slogan_of_the_day.slogan_printer'), $this->get('shopware.plugin.cached_config_reader'));
    }
    protected function getHooksService()
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/doctrine/attributes', 'proxyDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/shopware/apps/shopware/htdocs/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/shopware/apps/shopware/htdocs/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/'));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.requirements'] = new \Shopware\Components\Check\Requirements('/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Components/Check/Data/System.xml', $this->get('db_connection'));
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/var/www/html/shopware/apps/shopware/htdocs');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/var/www/html/shopware/apps/shopware/htdocs/snippets/');
    }
    ...
    {
        return $this->services['shopware_plugininstaller.legacy_plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\LegacyPluginInstaller($this->get('models'), $this->get('plugins'), array('Default' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/'));
    }
    protected function getShopwarePlugininstaller_PluginDownloadServiceService()
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/var/www/html/shopware/apps/shopware/htdocs', array('Default' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/'), $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    protected function getShopwarePlugininstaller_PluginInstallerService()
    {
        return $this->services['shopware_plugininstaller.plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\PluginInstaller($this->get('models'), $this->get('shopware.snippet_database_handler'), $this->get('shopware.plugin_requirement_validator'), $this->get('db_connection'), '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/');
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/var/www/html/shopware/apps/shopware/htdocs', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/var/www/html/shopware/apps/shopware/htdocs', array('Default' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Community/', 'ShopwarePlugins' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/'), $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/var/www/html/shopware/apps/shopware/htdocs', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/shopware/apps/shopware/htdocs',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020',
            'kernel.logs_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/log',
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'ShopwareProductionf043d3313d3fe9a3b4816321de40251dead18d95ProjectContainer',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'path' => '/var/www/html/shopware/apps/shopware/htdocs',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.path' => '/var/www/html/shopware/apps/shopware/htdocs',
            ...
            'shopware.db.username' => 'bn_shopware',
            'shopware.db.password' => '3586f81c65',
            'shopware.db.dbname' => 'bitnami_shopware',
            'shopware.db.host' => 'localhost',
            'shopware.db.charset' => 'utf8mb4',
            'shopware.db.adapter' => 'pdo_mysql',
            'shopware.db.port' => '3307',
            'shopware.es' => array(
                'prefix' => 'sw_shop',
                'enabled' => false,
                'write_backlog' => true,
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Default/',
                'Local' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Local/',
                'Community' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Community/',
                'ShopwarePlugins' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/',
            ),
            'shopware.plugin_directories.default' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.local' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.community' => '/var/www/html/shopware/apps/shopware/htdocs/engine/Shopware/Plugins/Community/',
            'shopware.plugin_directories.shopwareplugins' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/templates',
                'compileDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/templates',
            ),
            ...
            'shopware.template.cachedir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/templates',
            'shopware.template.compiledir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '6b31f590524ca83fc1748cc71858c417',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '6b31f590524ca83fc1748cc71858c417',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/doctrine/attributes',
                'proxyDir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/doctrine/attributes',
            'shopware.model.proxydir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/doctrine/proxies',
            ...
            'active_plugins' => array(
                ...
                'SwagPaymentPaypal' => '3.4.11',
                'GwennysSloganOfTheDay' => '0.0.1',
                'GwennySloganOfTheDay' => '0.0.1',
                'GwenSloganOfTheDay' => '0.0.1',
            ),
            'gwen_slogan_of_the_day.plugin_dir' => '/var/www/html/shopware/apps/shopware/htdocs/custom/plugins/GwenSloganOfTheDay',
            'gwen_slogan_of_the_day.plugin_name' => 'GwenSloganOfTheDay',
