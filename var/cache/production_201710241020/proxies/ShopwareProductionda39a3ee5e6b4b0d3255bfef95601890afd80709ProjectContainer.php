...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '6b31f590524ca83fc1748cc71858c417'), array('hashed_directory_perm' => 509, 'cache_file_perm' => 436, 'hashed_directory_level' => 3, 'cache_dir' => '/var/www/html/shopware/apps/shopware/htdocs/var/cache/production_201710241020/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['shopware_media.media_service_factory'] = new \Shopware\Bundle\MediaBundle\MediaServiceFactory($this, array(0 => $this->get('shopware_media.adapter.local'), 1 => $this->get('shopware_media.adapter.ftp')), array('backend' => 'local', 'strategy' => 'md5', 'liveMigration' => false, 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'permissions' => array('file' => array('public' => 436, 'private' => 384), 'dir' => array('public' => 509, 'private' => 448)), 'path' => '/var/www/html/shopware/apps/shopware/htdocs'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    {
        return $this->services['shopware_media.strategy_factory'] = new \Shopware\Bundle\MediaBundle\Strategy\StrategyFactory(array('backend' => 'local', 'strategy' => 'md5', 'liveMigration' => false, 'adapters' => array('local' => array('type' => 'local', 'mediaUrl' => '', 'permissions' => array('file' => array('public' => 436, 'private' => 384), 'dir' => array('public' => 509, 'private' => 448)), 'path' => '/var/www/html/shopware/apps/shopware/htdocs'), 'ftp' => array('type' => 'ftp', 'mediaUrl' => '', 'host' => '', 'username' => '', 'password' => '', 'port' => 21, 'root' => '/', 'passive' => true, 'ssl' => false, 'timeout' => 30))));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'shopware.cdn.adapters.local.permissions.file.public' => 436,
            'shopware.cdn.adapters.local.permissions.file.private' => 384,
            'shopware.cdn.adapters.local.permissions.dir' => array(
                'public' => 509,
                'private' => 448,
            ),
            'shopware.cdn.adapters.local.permissions.dir.public' => 509,
            ...
            'shopware.cache.backendoptions.hashed_directory_perm' => 509,
            'shopware.cache.backendoptions.cache_file_perm' => 436,
