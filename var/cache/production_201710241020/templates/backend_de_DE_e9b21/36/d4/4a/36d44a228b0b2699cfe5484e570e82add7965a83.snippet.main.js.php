<?php /* Smarty version Smarty-3.1.12, created on 2017-12-19 00:31:35
         compiled from "/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/product_stream/controller/main.js" */ ?>
<?php /*%%SmartyHeaderCode:17387828195a384fd7f3fa72-51674236%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '36d44a228b0b2699cfe5484e570e82add7965a83' => 
    array (
      0 => '/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/product_stream/controller/main.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17387828195a384fd7f3fa72-51674236',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a384fd8325363_98081889',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a384fd8325363_98081889')) {function content_5a384fd8325363_98081889($_smarty_tpl) {?>/**
 * Shopware 5
...
Neuer Name<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'stream_duplicate_prompt','default'=>'New name','namespace'=>'backend/product_stream/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
:',
                ...
                duplicatedRecord.save({
                    success: function (newRecord) {
                        if (newRecord.get('type') == 2) {
                            Ext.Ajax.request({
                                url: '<?php echo '/backend/ProductStream/copySelectedProducts';?>',
                                params: {
                        ...
                        Ext.Ajax.request({
                            url: '<?php echo '/backend/ProductStream/copyStreamAttributes';?>',
                            params: {
                                sourceStreamId: record.get('id'),
                                targetStreamId: newRecord.get('id')
                            }
...
Kopie von <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'stream_duplicate_copy','default'=>'Copy of ','namespace'=>'backend/product_stream/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
' + record.get('name'));
    }
});
//<?php }} ?>