<?php /* Smarty version Smarty-3.1.12, created on 2017-12-19 00:30:28
         compiled from "/var/www/html/shopware/apps/shopware/htdocs/engine/Library/ExtJs/components/Ext.util.FileUpload.js" */ ?>
<?php /*%%SmartyHeaderCode:15112182345a384f949d65a7-19396650%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9384e77c28dc7a6d4156048f908ff3eafb635f35' => 
    array (
      0 => '/var/www/html/shopware/apps/shopware/htdocs/engine/Library/ExtJs/components/Ext.util.FileUpload.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15112182345a384f949d65a7-19396650',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a384f94a89da0_71807928',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a384f94a89da0_71807928')) {function content_5a384f94a89da0_71807928($_smarty_tpl) {?>/**
 * Shopware 5
...
Dein Browser unterstützt nicht die benötigten Funktionen für einen Drag&Drop-Upload.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'legacy_message','default'=>'Your browser doesn\\\'t support the necessary feature to support drag &drop uploads.','namespace'=>'backend/component/file_upload'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Die selektierte Datei überschreitet die maximal erlaubte Uploadgröße. Bitte wähle eine andere Datei aus.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'max_upload_size_text','default'=>'The selected file exceeds the configured maximum file size for uploads. Please select another file to upload.','namespace'=>'backend/component/file_upload'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        extensionNotAllowedTitle: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'file_upload'/'extension_not_allowed_title','default'=>'File extension not allowed','namespace'=>'backend/component/file_upload')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'extension_not_allowed_title','default'=>'File extension not allowed','namespace'=>'backend/component/file_upload'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Dateiendung wird nicht unterstützt<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'extension_not_allowed_title','default'=>'File extension not allowed','namespace'=>'backend/component/file_upload'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
        extensionNotAllowedText: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>'file_upload'/'extension_not_allowed_title','default'=>'The selected file extension is not allowed. Please select another file to upload.','namespace'=>'backend/component/file_upload')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'extension_not_allowed_title','default'=>'The selected file extension is not allowed. Please select another file to upload.','namespace'=>'backend/component/file_upload'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Dateiendung wird nicht unterstützt<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'file_upload'/'extension_not_allowed_title','default'=>'The selected file extension is not allowed. Please select another file to upload.','namespace'=>'backend/component/file_upload'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
