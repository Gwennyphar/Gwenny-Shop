<?php /* Smarty version Smarty-3.1.12, created on 2017-12-18 19:30:27
         compiled from "/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/base/component/Shopware.Notification.js" */ ?>
<?php /*%%SmartyHeaderCode:14252289415a380943569a22-86408634%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c5bd97b5d9252d9355ab1a0b10fce41c8dd0638' => 
    array (
      0 => '/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/base/component/Shopware.Notification.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14252289415a380943569a22-86408634',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a3809435c9583_55033968',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3809435c9583_55033968')) {function content_5a3809435c9583_55033968($_smarty_tpl) {?>/**
 * Shopware 5
...
Ext.define('Shopware.Notification', {
    ...
    * @string
    */
    growlDisplayPosition: '<?php ob_start();?><?php echo 'top-right';?><?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?><?php echo 'top-right';?><?php }else{ ?>top-right<?php }?>',
    ...
    */
    ...
    createGrowlMessage: function(title, text, caller, iconCls, log) {
        ...
        if (log != false) {
            Ext.Ajax.request({
                url: '<?php echo '/backend/Log/createLog';?>',
                params: {
                    type: 'backend',
                    key: caller,
                    text: text,
