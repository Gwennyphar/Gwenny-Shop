<?php /* Smarty version Smarty-3.1.12, created on 2017-12-18 02:29:35
         compiled from "/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/article/view/detail/properties.js" */ ?>
<?php /*%%SmartyHeaderCode:3959204075a3719ff6e4244-87648439%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd72d79107ccb7d5fa09fcf13c1a3a1c069f4c2d9' => 
    array (
      0 => '/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/article/view/detail/properties.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3959204075a3719ff6e4244-87648439',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a3719ff94c1f5_11061383',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a3719ff94c1f5_11061383')) {function content_5a3719ff94c1f5_11061383($_smarty_tpl) {?>/**
 * Shopware 5
...
Um eine Produkteigenschaft zu konfigurieren, wählst du zunächst eine geeignete Produktgruppe über das Wahlfenster aus. Nachdem du eine Produktgruppe gewählt hast, wird ein Fenster mit allen verfügbaren Varianten angezeigt. Um diese Varianten zu ändern, klickst du einfach auf die zweite Spalte und wählst die von dir gewünschte Variante aus dem Kombinationsfeld (Mehrfachauswahl möglich). Pro Artikel ist die Zuweisung von einer Produktgruppe möglich. Beachte, dass beim Wechsel der Gruppe die bereits definierten Eigenschaften verloren gehen.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'properties'/'notice','default'=>'To configure an article property, please select a suitable property group via the selection box. Hereafter, a grid with all property values will be displayed. To change the values as well, you can click on the second grid column and modify the value via combo box (multiple selection possible).','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Du kannst mit der Tastatur durch drücken von Tab und Shift+Tab zwischen den verschiedenen Feldern wechseln und die ausgewählten Optionen mit ENTER hinzufügen. Neue Optionen können per STRG + ENTER hinzugefügt werden.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'detail'/'properties'/'description','default'=>'You have the ability to use the keyboard shortcuts Tab and Shift-Tab to navigate between the fields and CTRL+ENTER to add the selected options.','namespace'=>'backend/article/view/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
'
    },
    /**
    ...
    createValue: function(groupId, newValue) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/backend/Article/createPropertyValue';?>',
            method: 'POST',
            params: {
                value: newValue,
                groupId: groupId
