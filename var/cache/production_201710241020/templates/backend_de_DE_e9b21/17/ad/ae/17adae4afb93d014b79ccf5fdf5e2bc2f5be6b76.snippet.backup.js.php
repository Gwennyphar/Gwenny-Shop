<?php /* Smarty version Smarty-3.1.12, created on 2017-12-19 00:31:37
         compiled from "/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/article_list/controller/backup.js" */ ?>
<?php /*%%SmartyHeaderCode:12267034945a384fd954cd38-66234672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17adae4afb93d014b79ccf5fdf5e2bc2f5be6b76' => 
    array (
      0 => '/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/article_list/controller/backup.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12267034945a384fd954cd38-66234672',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a384fd9820a12_12747547',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a384fd9820a12_12747547')) {function content_5a384fd9820a12_12747547($_smarty_tpl) {?>/**
 * Shopware 5
...
Das gewählte Backup mit folgendem Zeitstempel wird gelöscht: [0]. Möchtest du fortfahren?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'backup'/'deleteConfirmMessage','default'=>'You are about to delete the selected backup from [0]. Do you want to proceed?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
', record.get('date')),
            function (response) {
                if ( response !== 'yes' ) {
                    return;
...
Konnte das Sicherungs-Verzeichnis nicht löschen - stelle sicher, dass es leer ist.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'errorDeleteMessage','default'=>'Could not delete the backup folder - make sure, it is empty','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
                    }
                });
...
Du wirst die gewählten Änderungen rückgängig machen. Fortfahren?<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'backup'/'addConfirm'/'Message','default'=>'You are about to revert the selected changes. Do you want to proceed?','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
            function (response) {
                if ( response !== 'yes' ) {
                    return;
...
Es ist ein unbekannter Fehler aufgetreten, bitte überprüfe deine Server-Logs<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>'unknownError','default'=>'An unknown error occurred, please check your server logs','namespace'=>'backend/article_list/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
');
                    return;
                }
