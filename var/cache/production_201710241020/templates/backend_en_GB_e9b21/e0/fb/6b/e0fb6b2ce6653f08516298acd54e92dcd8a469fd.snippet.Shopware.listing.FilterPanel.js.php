<?php /* Smarty version Smarty-3.1.12, created on 2017-12-18 15:49:47
         compiled from "/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/base/application/Shopware.listing.FilterPanel.js" */ ?>
<?php /*%%SmartyHeaderCode:1857306395a37d58bd4d3e3-32541239%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e0fb6b2ce6653f08516298acd54e92dcd8a469fd' => 
    array (
      0 => '/var/www/html/shopware/apps/shopware/htdocs/themes/Backend/ExtJs/backend/base/application/Shopware.listing.FilterPanel.js',
      1 => 1508840484,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1857306395a37d58bd4d3e3-32541239',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5a37d58be33639_29793057',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a37d58be33639_29793057')) {function content_5a37d58be33639_29793057($_smarty_tpl) {?>
...
Filters<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/title",'default'=>'Filters','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
     ...
     * @type { String }
     */
    infoTextSnippet: '<?php $_smarty_tpl->smarty->_tag_stack[] = array('snippet', array('name'=>"filter_panel/info_text",'default'=>'Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.','namespace'=>'backend/application/main')); $_block_repeat=true; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/info_text",'default'=>'Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.','namespace'=>'backend/application/main'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/info_text",'default'=>'Activate the filter by clicking the regarding checkbox. These filters will be linked with an AND condition.','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
...
Filter result<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo Enlight_Components_Snippet_Resource::compileSnippetBlock(array('name'=>"filter_panel/filter_button_text",'default'=>'Filter result','namespace'=>'backend/application/main'), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
',
